...
-(id) initWithType:(EnemyTypes)enemyType
{
	...
	if (self)
	{
		...
		{
			HealthbarComponent* healthbar = [HealthbarComponent spriteWithSpriteFrameName:@"energytranam.png"];
